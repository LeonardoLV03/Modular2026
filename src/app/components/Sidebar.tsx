...
import { Heart, Droplet, Wind, Flame, Bone, FlaskConical, Bug, Zap, Sun, Brain, AlertTriangle } from 'lucide-react';
...
const modules = [
  ...
  { id: 'picadura'    as Module, name: 'Picadura',         description: 'Mordedura o picadura',      icon: Bug,          color: '#3b0764', bgTint: 'rgba(59, 7, 100, 0.13)'},
...
export function Sidebar({ selectedModule, onModuleSelect }: SidebarProps) {
  return (
    <div className="flex h-full w-full flex-col overflow-hidden" style={{ background: '#0f0f1a' }}>
      {/* Logo */}
      <div className="flex flex-shrink-0 items-center gap-3 px-5 py-5" style={{ borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
      ...
      <div className="flex-shrink-0 px-5 py-4" style={{ borderTop: '1px solid rgba(255,255,255,0.07)' }}>
        <div className="flex items-start gap-2">
          <AlertTriangle size={13} className="mt-0.5 flex-shrink-0" style={{ color: 'rgba(245,158,11,0.6)' }} />
