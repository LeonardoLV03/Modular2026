    ...
    questions: [
      {
        ...
        options: ['Darle agua de inmediato', 'Recostarla y elevar sus piernas', 'Sentarla con la cabeza hacia adelante', 'Sacudirla para despertarla'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Por comer demasiado', 'Por una caída temporal del flujo sanguíneo al cerebro', 'Por dormir mal', 'Por hacer ejercicio'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['No tocarla', 'Aflojar cuellos, cinturones o prendas ajustadas', 'Cubrirla con varias capas', 'Quitarle los zapatos únicamente'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Esperar más tiempo', 'Llamar a emergencias de inmediato', 'Darle café', 'Dejarla sola para que descanse'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Sí, inmediatamente', 'No, hasta que esté completamente consciente y alerta', 'Solo agua', 'Solo si lo pide'],
        correctIndex: 1,
    ...
    questions: [
      {
        ...
        options: ['Aplicar torniquete', 'Presión directa sobre la herida', 'Elevar la extremidad únicamente', 'Llamar a emergencias antes que nada'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Con la mano directa sin nada más', 'Con una tela limpia o gasa', 'Con hielo directo', 'Con alcohol'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['En cualquier corte pequeño', 'Solo si la hemorragia es severa y no se controla con presión directa', 'Nunca es recomendable', 'Antes de intentar la presión directa'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Quitar la tela y poner una nueva', 'Agregar más tela encima sin quitar la anterior', 'Dejar de presionar', 'Lavar la herida con agua'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Un raspón leve', 'Sangrado que no para después de varios minutos de presión, o mareo/palidez', 'Un moretón', 'Comezón en la piel'],
        correctIndex: 1,
    ...
    questions: [
      {
        ...
        options: ['Tose fuerte y habla normal', 'Se lleva las manos al cuello y no puede hablar ni toser', 'Solo estornuda', 'Se ríe nerviosamente'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Darle agua', 'Maniobra de Heimlich (compresiones abdominales)', 'Golpear la espalda suavemente una vez', 'Hacerla vomitar con el dedo'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Aplicar Heimlich de inmediato', 'Animarla a seguir tosiendo, sin intervenir todavía', 'Darle palmadas fuertes en el pecho', 'Acostarla boca abajo'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Dejarla en el suelo y esperar', 'Recostarla con cuidado e iniciar RCP, llamando a emergencias', 'Darle de beber agua', 'Sacudirla fuerte'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Compresiones abdominales igual que en adultos', 'Golpes en la espalda y compresiones en el pecho, alternadas', 'Sacudirlo boca abajo con fuerza', 'Nada, solo esperar'],
        correctIndex: 1,
    ...
    questions: [
      {
        ...
        options: ['Aplicar hielo directo', 'Enfriar con agua corriente tibia/fría por varios minutos', 'Poner mantequilla o aceite', 'Reventar cualquier ampolla'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Porque no hace nada', 'Porque puede dañar más el tejido por el frío extremo', 'Porque mancha la piel', 'Sí se debe usar hielo'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Reventarlas para liberar el líquido', 'No reventarlas, protegen la piel de infecciones', 'Rascarlas', 'Cubrirlas con algodón directo'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Siempre, sin excepción', 'Si es extensa, profunda, o está en cara/manos/genitales', 'Solo si duele mucho', 'Nunca es urgente'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Algodón suelto', 'Gasa limpia y no adherente', 'Papel higiénico', 'Nada, dejarla al aire libre siempre'],
        correctIndex: 1,
    ...
    questions: [
      {
        ...
        options: ['Intentar acomodar el hueso', 'Inmovilizar la zona y evitar que se mueva', 'Hacer que camine para ver si duele', 'Aplicar calor directo'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Dolor leve que desaparece rápido', 'Deformidad visible, hinchazón intensa o incapacidad para mover la zona', 'Solo un poco de comezón', 'Enrojecimiento sin dolor'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Sí, siempre', 'No, nunca — solo inmovilizar en la posición encontrada', 'Solo si no duele', 'Solo en brazos'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Empujar el hueso de vuelta', 'Cubrir con tela limpia sin presionar el hueso, y buscar ayuda urgente', 'Lavar el hueso con agua', 'Ignorarlo si no sangra'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Solo con materiales médicos oficiales', 'Con objetos rígidos como tablas o revistas enrolladas, bien sujetos', 'Con una toalla suelta', 'No es posible improvisar'],
        correctIndex: 1,
    ...
    questions: [
      {
        ...
        options: ['Inducir el vómito siempre', 'Llamar al centro de toxicología o emergencias antes de actuar', 'Darle leche de inmediato', 'Esperar a ver si mejora solo'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Siempre es seguro hacerlo', 'Algunas sustancias (como corrosivos) pueden dañar más al devolverse', 'El vómito nunca ayuda', 'No hay ninguna razón'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Quedarse en el lugar', 'Sacar a la persona al aire libre lo antes posible', 'Cerrar puertas y ventanas', 'Darle agua primero'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Nada en particular', 'Qué sustancia fue, cuánta cantidad, y a qué hora ocurrió', 'Solo el nombre de la persona', 'El color de la sustancia únicamente'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Darle de beber agua', 'Colocarla de lado (posición de recuperación) y llamar a emergencias', 'Sentarla derecha', 'Dejarla boca arriba sin más'],
        correctIndex: 1,
    ...
    questions: [
      {
        ...
        options: ['Apretar la zona con los dedos', 'Retirar el aguijón raspando con una tarjeta o uña, sin apretar', 'Ignorarlo', 'Aplicar alcohol directo sobre el aguijón'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Solo comezón leve', 'Dificultad para respirar, hinchazón de cara/garganta, o mareo intenso', 'Un pequeño enrojecimiento', 'Nada en especial'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Agua caliente', 'Compresa fría o hielo envuelto en tela', 'Alcohol directo', 'Nada, dejar como está'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['No usarlo, esperar ayuda', 'Ayudarla a usarlo según las instrucciones y llamar a emergencias', 'Usarlo solo si lo pide tres veces', 'Guardarlo para después'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Sí, todo lo que se pueda', 'No es recomendable, puede causar infección', 'Solo con las uñas cortas', 'Da igual'],
        correctIndex: 1,
    ...
    questions: [
      {
        ...
        options: ['Tocarla para ver si reacciona', 'Cortar la fuente de electricidad o alejarla con un objeto no conductor', 'Echarle agua', 'Sacudirla'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Metal', 'Materiales secos y no conductores como madera o plástico', 'Agua', 'Cualquier objeto sirve'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['No es importante', 'La corriente puede afectar el ritmo cardiaco y la respiración', 'Solo por costumbre', 'Solo si hay quemaduras visibles'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Sí, siempre se ven claramente', 'No, puede haber daño interno grave sin quemaduras externas grandes', 'Nunca hay quemaduras', 'Solo en electricidad de alto voltaje'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['No, solo si hay quemaduras', 'Sí, siempre se recomienda evaluación médica', 'Solo si pierde el conocimiento', 'Nunca es necesario'],
        correctIndex: 1,
    ...
    questions: [
      {
        ...
        options: ['Abrigar a la persona', 'Llevarla a un lugar fresco y bajar su temperatura gradualmente', 'Darle café caliente', 'Ponerla al sol para que sude'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Sudoración normal y sed leve', 'Piel muy caliente y seca, confusión, o pérdida de consciencia', 'Solo un poco de cansancio', 'Hambre'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Bebidas alcohólicas', 'Agua fresca en sorbos pequeños', 'Bebidas muy azucaradas en grandes cantidades', 'Nada de líquidos'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Cobijas gruesas', 'Compresas frías en cuello, axilas e ingles', 'Ropa extra', 'Ejercicio ligero'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Nunca es necesario', 'Si hay confusión, pérdida de consciencia, o la temperatura corporal es muy alta', 'Solo si dura más de una semana', 'Solo si hay quemaduras solares'],
        correctIndex: 1,
    ...
    questions: [
      {
        ...
        options: ['Sujetarla con fuerza para que no se mueva', 'Despejar el área a su alrededor de objetos peligrosos', 'Meterle algo en la boca', 'Darle agua'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Sí, para evitar que se muerda la lengua', 'No, nunca — puede causar más daño o asfixia', 'Solo una cuchara', 'Solo los dedos'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Sujetarla firme para que no se mueva', 'Colocar algo suave debajo y voltearla de lado si es posible', 'Levantarla', 'No tocarla en absoluto'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Siempre, sin excepción, incluso si dura pocos segundos', 'Si dura más de 5 minutos, se repite, o la persona no respira bien después', 'Nunca es necesario llamar', 'Solo si la persona lo pide'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Energía total inmediata', 'Confusión, cansancio o desorientación temporal', 'Nada en absoluto', 'Hambre extrema únicamente'],
        correctIndex: 1,
